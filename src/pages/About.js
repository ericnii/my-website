    ...
    <section id='about' className='about-page'>
      ...
      <div className='about-container'>
        ...
        <div className='about-text-container'>
          ...
          <p className='about-text2'>Currently, I am working @ MarkiTech.AI as a Software Engineer Intern. I'm always looking for opportunities to collaborate, contribute to meaningful projects, and learn.</p>
